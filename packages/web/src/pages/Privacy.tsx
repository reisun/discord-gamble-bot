  ...
  return (
    <div style={{ maxWidth: 720, margin: '0 auto', lineHeight: 1.8 }}>
      ...
      <section>
        <h3>3. 保存期間</h3>
        <p>
          イベントに関連するデータ（ユーザーの表示名・アバターURL・賭け内容・ポイント履歴など）は、
          <strong>そのイベントに初めてユーザー情報が登録された日時から2週間後</strong>に自動削除されます。
        </p>
      ...
      <section>
        <h3>4. 削除方針</h3>
        <ul>
          <li>イベントデータ: 初回ユーザー登録から2週間後にイベントと関連データ（ゲーム、賭け、ポイント履歴、借金履歴）が自動���除されます</li>
          <li>ユーザー個人情報: どのイベントにも紐づかなくなったユーザ��の表示名・アバターURLは自動的にNULL化されます</li>
